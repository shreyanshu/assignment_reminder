...
public class ClassOf2019 extends AppCompatActivity {

    DatabaseHelper databaseHelper = new DatabaseHelper(this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_class_of2019);

        ListView listView = (ListView) findViewById(R.id.list_2019);
        List<Assignment> assList = databaseHelper.fetchBatchAssignment("2019");
