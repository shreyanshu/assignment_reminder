...
public class ClassOf2017 extends AppCompatActivity {

    DatabaseHelper databaseHelper = new DatabaseHelper(this);
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_class_of2017);

        ListView listView = (ListView) findViewById(R.id.list_2017);
        List<Assignment> assList = databaseHelper.fetchBatchAssignment("2017");
